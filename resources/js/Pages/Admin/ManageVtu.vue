      ...
      <div v-if="current_page == 6" class="mt-[30px]">
        <CardBox class="mb-6" @submit.prevent="submitAirtimeSettingsForm" isForm>
          ...
          <div class="sm:grid sm:grid-cols-12 sm:gap-6 mt-[50px]">
            ...
            <FormField class="sm:col-span-6" label="Discount">
            ...
            <FormField class="sm:col-span-6" label="Percentage">
              <FormControl v-model="airtime_settings_form.upline_percentage" :error="airtime_settings_form.errors.upline_percentage"
                type="number" />
            </FormField>

            <FormField class="sm:col-span-6" label="Number of generations">
              <FormControl v-model="airtime_settings_form.upline_generations" :error="airtime_settings_form.errors.upline_generations"
                type="number" />
            </FormField>
